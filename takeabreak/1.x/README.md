...
To test the previous commands, you can use two input FASTA files, containing the test reads and the reference reads, available [here](http://evolution6.i3s.up.pt/static/pegi3s/dockerfiles/input_test_data/takeabreak_input.zip).
