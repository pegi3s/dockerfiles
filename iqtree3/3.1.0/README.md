...
`docker run --rm -v /your/work/dir:/data pegi3s/iqtree3 iqtree3 -s /data/your_alignment.fasta -m MFP -mtree --merit BIC -B 1000 -alrt 1000 --bnni --seed 1 --prefix /data/output_files/run1 -T AUTO`

In this command, you should replace:
- `/your/work/dir` with your actual working directory
...
`docker run --rm -v /your/work/dir:/data pegi3s/iqtree3 iqtree3 -s /data/your_alignment.fasta -m MF -mtree --merit BIC --prefix /data/output_files/modeltest -T AUTO`

### Use a fixed model instead of automatic model selection
`docker run --rm -v /your/work/dir:/data pegi3s/iqtree3 iqtree3 -s /data/your_alignment.fasta -m GTR+F+I+G4 --prefix /data/output_files/run1 -T AUTO`

### Partitioned analysis
`docker run --rm -v /your/work/dir:/data pegi3s/iqtree3 iqtree3 -s /data/concat_alignment.fasta -p /data/partitions.nex -m MFP+MERGE --merit BIC -B 1000 --seed 1 --prefix /data/output_files/run1 -T AUTO`
