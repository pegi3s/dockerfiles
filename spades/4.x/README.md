...
The [SPAdes](http://cab.spbu.ru/software/spades/) manual can be found [here](https://github.com/ablab/spades#readme). This image allows you to use the main `SPAdes` scripts, namely:
...
- `[options]` with the input data and other parameters. Refer to the [SPAdes manual](https://github.com/ablab/spades#readme) to know how this information should be given.
...
*Note*: the analysis of these files may take a while.
