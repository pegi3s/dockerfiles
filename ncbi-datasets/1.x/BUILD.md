...
```bash
datasets_version=18.37.0 && docker build ./ -t pegi3s/ncbi-datasets:${datasets_version} --build-arg VERSION=${datasets_version}  && docker tag pegi3s/ncbi-datasets:${datasets_version} pegi3s/ncbi-datasets:latest

# Build log

- 18.37.0 - 24/09/2026 - Hugo López Fernández
