...
# Test data
To test the previous command, you can download [this FASTQ compressed file](ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR165/000/SRR1654650/SRR1654650.fastq.gz) (1.1GB). Note that it does not need to be decompressed as `FastQC` can deal with both compressed and uncompressed FASTQ files. 
