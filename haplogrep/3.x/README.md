...
`docker run --rm -v /your/data/dir:/data pegi3s/haplogrep classify --input=/data/input --tree=phylotree-rcrs@17.3 --out data/out.txt`
...
- You may also want to replace `phylotree-rcrs@17.3` for another reference sequence.
