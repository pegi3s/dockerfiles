...
To test the previous commands, the input files are available [here](http://evolution6.i3s.up.pt/static/pegi3s/dockerfiles/input_test_data/samtools_bcftools.zip).
...
To test the previous commands, the input files are available [here](http://evolution6.i3s.up.pt/static/pegi3s/dockerfiles/input_test_data/samtools_bcftools.zip). Replace `sortedbamfilename.bam` to `hg38_example.bam` to run the example commands.
